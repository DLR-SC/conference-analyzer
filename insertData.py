...
a = insertData("bolt://127.0.0.1:7687", "neo4j", "Gjekgi75")
c = Conference("SciPy EU 2017", "USA", "00002000")
cs = Conference_Series("SciPy", 1)
t = Talk("How I wrote good bad code", "en")
to = Topic("Code Optimizing in Python", "Python, Optimizing")
a.insert_data("Amson Ramson", c, cs, t, to)
a.close()